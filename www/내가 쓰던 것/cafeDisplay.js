...
function displayCafeInfo(index) {
	...
	$('#cafeInfoArea').html(name + tyep + score + region + phone + address + memo);
	$.moblie.changePage("#cafeInfoShowPage", "slide", false, true);
}
...
function getCafePic() {
	...
	$.moblie.changePage("#picShowDialog", "pop", false, true);
}
...
function getCafeRouteMap() {
	...
	$.moblie.changePage("#routeShowDialog", "pop", false, true);
